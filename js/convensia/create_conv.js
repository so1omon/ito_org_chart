...
$(document).ready(function(){
            ...
            // 2. 각 사원의 status(근무상태)를 설정 - (16F/create.js)와 동일
            $.ajax({
                method:'POST',
                url:'/status',
                data:{},
            ...
            // 3. 각 실장님 클릭시 detail 모달창 (다른 사원과 내부 요소들이 달라서 따로 구현함) -(16F/create.js)와 동일
            ...
            // 4. 사원 이미지 클릭시 detail 모달창 띄움 - (16F/create.js)와 동일
            ...
            // 5. 모달창 뒤 검은 배경 누르면 창 닫힘 -(16F/create.js)와 동일
            ...
            // 6. X 버튼 누르면 창 닫힘 - (16F/create.js)와 동일
...
//8. 3600 초마다 refresh 함수 (16F/create.js)와 동일
